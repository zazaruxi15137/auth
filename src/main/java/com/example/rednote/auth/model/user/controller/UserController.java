...
public class UserController {
     ...
     */
    @PostMapping("/login")
    public RespondMessage<UserDto> loginPage(@RequestBody @Valid LoginUser loginUserDto) throws JsonProcessingException {
        // 验证用户名密码是否正确
        ...
        log.info("已查询到登录用户权限为{}",permissions.toString());
