...
import com.example.rednote.auth.repository.PermissionRoleRepositiry;
import com.example.rednote.auth.repository.RoleRepository;
...
public class PermissionRoleServiceImpl implements PermissionRoleService{
    ...
    public List<String> getPermissionByRoles(String roles) {
        ...
        log.info("已查询到登录用户权限为{}",roleList.toString());
        return roleList;
    }
